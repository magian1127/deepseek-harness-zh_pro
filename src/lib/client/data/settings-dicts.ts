...
const SETTINGS_ZH = {
  ...
  serviceMonitorDesc: '左侧会话列表与设置之间显示对话中启动的本地服务（绿色圆点 + 地址，点击在新标签页打开）',
  ...
  serviceTargetsDesc: '填写名称和地址后点「添加」，条目常驻监控面板：在线绿点、离线灰点，点击在线条目在新标签页打开',
...
const SETTINGS_EN = {
  ...
  serviceMonitorDesc: 'Show locally started services between the session list and Settings in the sidebar (green dot + address; click to open in a new tab)',
  ...
  serviceTargetsDesc: 'Fill in a name and address, then click Add; entries stay in the panel permanently: green dot when online, gray dot when offline, click an online entry to open it in a new tab',
