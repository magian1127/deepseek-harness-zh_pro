...
<p align="center">
  <img alt="版本 0.9.0" src="https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.9.0-5965d8">
...
| 对话列表相关 | 查看已归档 | 开 | 在工作区行提供归档视图；归档行可恢复、重命名、分叉或删除 |
| 对话列表相关 | 会话删除按钮 | 开 | 在会话三点菜单显示“删除会话”；日志移入系统回收站，不保留列表恢复位 |
| 对话列表相关 | 会话多选 | 开 | 空闲会话行可勾选，多选后可批量删除或批量归档；运行中、待交互及完成未读会话不可选 |
...
| 代理角色提示中文化、工具说明中文化、提示词开关/文本/目标、自动归档天数 | DSH `settings.yaml`，命名空间 `dsh-zh` |
